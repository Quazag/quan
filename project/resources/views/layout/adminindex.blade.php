        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
                <ul>
                    ...
                    <li>
                        <a href="#"><i class="icon-users"></i>用户</a>
                        <ul class="closed">
                    ...
                    <li>
                        <a href="#"><i class="icon-align-justify"></i>分类</a>
                        <ul class="closed">
                     ...
                     <li>
                        <a href="#"><i class="icon-bag"></i>商品</a>
                        <ul class="closed">
                            <li><a href="/admin/cate/index">商品浏览</a></li>
                            <li><a href="/admin/cate/add">商品添加</a></li>
                            
                        </ul>
                    </li>
                     <li>
                        <a href="#"><i class="icon-file"></i>订单</a>
                        <ul class="closed">
                            <li><a href="/admin/cate/index">订单浏览</a></li>
                            <li><a href="/admin/cate/add">分类添加</a></li>
                     ...
                     <li>
                        ...
                        <ul class="closed">
                            <li><a href="/admin/cate/index">商品</a></li>
                            <li><a href="/admin/cate/add">订单</a></li>
                            <li><a href="/admin/drop/uindex">用户</a></li>
