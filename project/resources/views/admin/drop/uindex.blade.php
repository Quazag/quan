...
<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i> 用户回收站</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
							<form action="/admin/drop/uindex" method="get">
                        ...
                        @endif
                                    ...
                                    <td class=" "align="center">
                                    	<a href="/admin/drop/del/{{$v['id']}}/{{'user'}}" class="icon-trash" style="font-size:30px"></a> &nbsp &nbsp &nbsp &nbsp
                                    	<a href="/admin/drop/edit/{{$v['id']}}/{{'user'}}" class="icon-magic" style="font-size:25px"></a>
                                    </td>
                                </tr>
                         @endforeach
                        </tbody>
